...
class RecuPdf
{
    ...
    {
        $this->recu = $recu;
        $this->pdf  = new \TCPDF('P','mm','A5');
        
        $this->pdf->SetMargins(0, 0);
        $this->pdf->SetAutoPageBreak(false);
        
        $this->pdf->AddFont('Vera', '', Config::get('data_dir').DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.'Vera.php');
        $this->pdf->AddFont('Vera', 'B', Config::get('data_dir').DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.'VeraBd.php');
        $this->pdf->AddFont('Vera', 'BI', Config::get('data_dir').DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.'VeraBI.php');
        $this->pdf->AddFont('Vera', 'I', Config::get('data_dir').DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR.'VeraIt.php');
